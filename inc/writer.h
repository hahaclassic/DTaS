...
#define MENU "=======================================================================================\n" \
             ...
             "| Операции                                                                            |\n" \
             "|-------------------------------------------------------------------------------------|\n" \
             "| 1. Проверка корректности с пощомью стека в виде статического массива                |\n" \
             "| 2. Проверка корректности с пощомью стека в виде односвязного списка                 |\n" \
             "| 3. Проверка корректности с пощомью стека в виде статического массива (с доп. инфо)  |\n" \
             "| 4. Проверка корректности с пощомью стека в виде односвязного списка (с доп. инфо)   |\n" \
